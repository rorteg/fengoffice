...
Ces valeurs ne s\'appliquent qu\'aux utilisateurs n\'ayant pas encore modifié leurs options. ',
	...
	'config option name use_owner_company_logo_at_header' => 'Utiliser le logo du propriétaire de la société comme logo de l\'application',
	'config option desc use_owner_company_logo_at_header' => 'place le logo du propriétaire de la société',
	'config option name check_spam_in_subject' => 'Vérifier la présence du texte "**SPAM**" dans le sujet des courriels',
	'config option desc check_spam_in_subject' => 'Si le texte "**SPAM**" est trouvé dans le sujet du courriel, celui-ci est placé dans le dossier Indésirables',
	'config option name block_login_after_x_tries' => 'Bloquer l\'accès après 5 tentatives infructueuses',
	'config option desc block_login_after_x_tries' => 'Si un utilisateur essaie de s\'identifier 5 fois sans succès durant les 10 dernières minutes, son compte sera bloqué pendant 10 minutes supplémentaires.',
	'user ws config option name classify_mail_with_conversation' => 'Classer les courriels selon la conversation',
	'user ws config option desc classify_mail_with_conversation' => 'Si activé, les courriels reçus seront classés dans le contexte de la conversation (si le courriel suit une conversation)',
	'user ws config option name displayed events amount' => 'Nombre d\'évènements affichés',
	'user ws config option desc displayed events amount' => 'Le nombre d\'évènements par jour qui sont affichés dans la vue mensuelle',
	'sync' => 'Synchro',
	'user ws config option name show_file_revisions_search' => 'Voir les révisions des fichiers lors des recherches',
); ?>
