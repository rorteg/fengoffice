<?php return array(
	...
	// Persons
	'add user' => 'Agregar Persona',
	'add user role' => 'Rol',
  	'add user action' => 'Agregar persona para usar tu Feng Office',
  	'add user button' => 'Agregar Persona',
  	'add user hide settings' => 'Ocultar todas las Configuaraciones para este Usuario',
  	'add user show settings' => 'Ver todas las Configuaraciones para este Usuario',
  	'add user show settings text' => 'Como esta persona va a usar el Feng Office, es posible que desee establecer los detalles específicos, como los permisos de acceso<br /> (limitado por defecto), zona horaria, la contraseña, la categoría de facturación, etc.',
  	'add user essential' => 'Información Escencial',
  	'add user essential text' => 'Esta es la única información obligatoria en este formulario. Después de hacer clic en "Añadir persona"<br /> la dirección de correo electrónico recibirán una invitación para unirse a su Feng Office.',
	'add user what does' => 'Qué hace esta Persona',
	'add user what does text' => 'Usted dirá mucho acerca de una persona mediante el establecimiento de la función y en qué compañía.<br />Al seleccionar una función de usuario se define como la persona que, básicamente, usar el Feng Office.',
	'add user others' => 'Acceso y Otras Configuraciones',
	'add user others text' => 'Establecer qué proyectos se esta persona pueda tener acceso. Establecer contraseñas, zona horaria, idioma y otras opciones de configuración del sistema.',
