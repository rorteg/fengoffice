<?php
  ...
  return array(
    // ########## QUERY ERRORS ###########
    'CAL_QUERY_GETEVENT_ERROR' => 'データベースエラー: IDのイベントを取得できませんでした。',
    'CAL_QUERY_SETEVENT_ERROR' => 'データベースエラー: イベントのデータをセットできませんでした。',
    // ########## SUBMENU ITEMS ###########
    'CAL_SUBM_LOGOUT' => 'ログアウト',
    'CAL_SUBM_LOGIN' => 'ログイン',
    'CAL_SUBM_ADMINPAGE' => '管理ページ',
    'CAL_SUBM_SEARCH' => '検索',
    ...
    'CAL_NO_WRITE_PERMISSION' => 'イベントの作成や編集する権限がありません。',
    'CAL_NO_EDITOTHERS_PERMISSION' => '他のユーザーのイベントを編集する権限がありません。',
    'CAL_NO_EDITPAST_PERMISSION' => '過去のイベントを作成や編集する権限がありません。',
    'CAL_NO_ACCOUNTS' => 'このカレンダーはアカウントに許可されていません; 管理者だけログオンできます。',
    'CAL_NO_MODIFY' => '修正できません。',
    'CAL_NO_ANYTHING' => 'このページにまったく権限がありません。',
    ...
    'CAL_MORE_TIME_OPTIONS' => 'さらに時間のオプション',
    'CAL_REPEAT' => '繰り返し',
    'CAL_EVERY' => '毎',
    'CAL_REPEAT_FOREVER' => '無期限に繰り返し',
    'CAL_REPEAT_UNTIL' => '期間まで繰り返し',
    'CAL_TIMES' => '回',
    'CAL_HOLIDAY_EXPLAIN' => '繰り返すイベントを作成します。',
    'CAL_DURING' => '期間',
    'CAL_EVERY_YEAR' => '毎年',
    'CAL_HOLIDAY_EXTRAOPTION' => 'または、この月の最終週となるので、ここをチェックしてイベントを最後とします。',
'CAL_IN' => 'in',
    'CAL_PRIVATE_EVENT_EXPLAIN' => 'プライベートなイベント',
    'CAL_SUBMIT_ITEM' => 'アイテムを提出',
    'CAL_MINUTES' => '分',
    'CAL_MINUTES_SHORT' => '分',
    'CAL_TIME_AND_DURATION' => '日付、時刻、期間',
    'CAL_REPEATING_EVENT' => '繰り返すイベント',
    'CAL_EXTRA_OPTIONS' => '拡張オプション',
    'CAL_ONLY_TODAY' => 'しない',
    'CAL_DAILY_EVENT' => '日で繰り返し',
    'CAL_WEEKLY_EVENT' => '週で繰り返し',
    'CAL_MONTHLY_EVENT' => '月で繰り返す',
    'CAL_YEARLY_EVENT' => '年で繰り返し',
    'CAL_HOLIDAY_EVENT' => '休日を繰り返し',
    'CAL_UNKNOWN_TIME' => '不明な開始時間',
    'CAL_ADDING_TO' => '追加',
    'CAL_ANON_ALIAS' => '別名',
    'CAL_EVENT_TYPE' => 'イベントのタイプ',
    ...
    'CAL_DELETE' => '削除',
    'CAL_MODIFY' => '変更',
    'CAL_NOT_SPECIFIED' => '詳細は未定',
    'CAL_FULL_DAY' => '終日',
    'CAL_HACKING_ATTEMPT' => 'クラッキングの試み - IPアドレスを記録しました。',
    'CAL_TIME' => '時間',
    'CAL_HOURS' => '時間',
    'CAL_HOUR' => '時間',
    'CAL_ANONYMOUS' => '匿名',
    ...
    'event invitations' => '人々を招待',
    'event invitations desc' => '選択した人々をこのイベントに招待',
    'send new event notification' => '通知のメールを送信',
    'new event notification' => '新しいイベントが追加しました。',
    ...
    'all users' => 'すべてのユーザー',
    'error delete event' => 'イベントの削除中にエラー',
    'event invitation response' => 'イベントの招待に回答',
    'user will attend to event' => '{0}はこのイベントに出席の予定です。',
    'user will not attend to event' => '{0}はこのイベントに欠席の予定です。',
  	'also confirmed attendance' => '受諾した出席者にも',
  	'awaiting confirmation' => '回答待ち',
    'rejected invitation' => '出席しない予定', 
    ...
    'invitations' => '招待',
    'pending response' => '未回答',
    'participate' => '出席予定',
    'no invitations to this event' => 'このイベントの招待を送信されていません。',
    ...
    'copy this url in your calendar client software' => 'このカレンダーからイベントをインポートするには、このURLをカレンダーのクライアントのソフトウェアにコピーしてください。',
